...
const DEFAULT_STATE = {
  ...
  resumo_dia: '',
  sono: { dormiu_as: '', acordou_as: '', acordou_noite: null, cochilo_inicio: '', cochilo_fim: '', notas: '' },
  tela: { usou_tela: null, tempo_minutos: 0, conteudo: '', reacao_retirada: '' },
  alimentacao: { comeu_bem: null, aceitou: [], recusou: [], comeu_sentado: null, utensilio: '' },
  comunicacao: { usou_gestos: null, palavras_ditas: [], apontou: null, puxou_mao: '', respondeu_nome: '', imitou: null },
  brincar: { com_que_brincou: [], modo: '', fez_faz_de_conta: null, tempo_sem_tela_minutos: 0 },
  higiene: { banho: '', escovou_dentes: null, sinalizou_banheiro: null },
  vestuario: { colaborou_roupa: null, incomodo_sensorial: null },
  movimento: { atividades: [], caiu_muito: null, buscou_colo: null },
  humor: { humor_geral: '', teve_crise: null, o_que_acalmou: '', cobertor_disponivel: null, se_acalmou_sem_cobertor: null, notas: '' },
  rotina: { guardou_brinquedos: null, ajudou_tarefa: null, aceitou_transicao: null, teve_escola: null },
